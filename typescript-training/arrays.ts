...
let fruitsReversed: string[] = ["carrot", "potato", "tomato"];
console.log(fruitsReversed);
fruitsReversed.reverse();
console.log(fruitsReversed);

//13. Sort the values within the array.
console.log("Sort the values within the array");
let numbers1: number[] = [300, 80, 200, 220];
console.log(numbers1);
numbers1.sort((a, b) => a - b);//sort in ascending order
console.log(numbers1);
numbers1.sort((a, b) => b - a);//sort in descending order
console.log(numbers1);
